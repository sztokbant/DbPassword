...
public class DbPasswordTest {
	...
	public void sha1sumTest() throws Exception {
		...
		assertEquals(hash, new DbPassword("my shared secret").sha1sum("password", "salt"));
	}

	@Test
	public void sha1sumTestThatWasFailing() throws Exception {
		String hash = "050f505210c108d3edede76626009b3dbc940c0f";
		assertEquals(hash, new DbPassword("this secret phrase enhances the protection of our passwords").sha1sum("153000", "ffac"));
	}

	@Test
	public void yetAnotherSha1sumTestThatWasFailing() throws Exception {
		String hash = "0594936720627008a8c019da0727d8a41deb4b0c";
		assertEquals(hash, new DbPassword("this secret phrase enhances the protection of our passwords").sha1sum("marcos", "35c4"));
	}
